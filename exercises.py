...
def apply_discount(*args):
    discount = (args[0]* args[1])/100
    total = args[0] - discount
    return total
...
def convert_temperature(*args):
    if args[1] == 'C':
        f_temp = (args[0] * 9/5) + 32
        return f_temp
    if args[1] == 'F':
        c_temp = (args[0] - 32) * 5/9
        return c_temp
...
print('Exercise 6:', largest(20, 13, 30))
...
def calculate_tip(*args):
    tip = (args[0] * args[1])/100
    return tip

print('Exercise 7:', calculate_tip(50, 10))
...
print('Exercise 8:', product(2, 5, 8))
